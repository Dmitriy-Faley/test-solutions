...
function test_scripts() {
	...
	wp_enqueue_style('test-style-appcss', get_template_directory_uri() .'/assets/css/app.css', array(), _S_VERSION);
	wp_enqueue_script( 'test-appjs', get_template_directory_uri() . '/assets/js/app.js', array(), '1.0', true );
